...
To train a given algorithm for some number of time steps::
    ...
    mimoEnv
    python3 illustrations.py --env=selfbody --train_for=20000 --test_for=1000 --algorithm=PPO --save_model=selfbody1

To review a trained model::

    python3 illustrations.py --env=selfbody --test_for=1000 --load_model=models/selfbody/selfbody1/model_1

    python3 illustrations.py --env=selfbody --test_for=1000 --algorithm=PPO --load_model=model_1
...
def test(env, save_dir, test_for=1000, model=None, render_video=True):
